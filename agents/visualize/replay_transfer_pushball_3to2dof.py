...
Usage :
  python replay_transfer_pushball_3to2dof.py              # succès (défaut)
  python replay_transfer_pushball_3to2dof.py --fail
  python replay_transfer_pushball_3to2dof.py --fail --ep 3
  python replay_transfer_pushball_3to2dof.py --success --delay 0.05
"""

...
Usage :
  python replay_transfer_reach_2to3dof.py              # succès (défaut)
  python replay_transfer_reach_2to3dof.py --fail
  python replay_transfer_reach_2to3dof.py --fail --ep 3
  python replay_transfer_reach_2to3dof.py --success --delay 0.05
"""

...
def main():
    ...
    parser.add_argument("--animate", action="store_true", help="Animer tous les états de la trajectoire.")
    parser.add_argument("--delay", type=float, default=0.05, help="Délai entre deux images pour l'animation, en secondes.")
    ...
    model_path = base_dir / "runs" / args.run_id / "models" / "r1_to_r2.pt"

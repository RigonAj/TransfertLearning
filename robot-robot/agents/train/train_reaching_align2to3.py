...
if multiprocessing.current_process().name == "MainProcess":
    ...
    # override hyperparams (fine-tuning stable)
    ...
    # SAVE
    # ==========================
    model.save(os.path.join(model_dir, "align_2to3_final"))
    train_env.save(os.path.join(model_dir, "vecnormalize.pkl"))

    print("Alignment training finished")
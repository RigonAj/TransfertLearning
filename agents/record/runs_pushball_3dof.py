"""
runs_pushball_3dof.py
Collecte 20 épisodes réussis et 20 épisodes échoués pour le push-ball 3-DOF.
Sauvegarde les trajectoires complètes dans :
  runs/pushball_3dof/success/ep_XXX.npz
  runs/pushball_3dof/fail/ep_XXX.npz
"""
...
# ── Configuration ──────────────────────────────────────────────────────────────
RUN_ID       = 1
MODEL_PATH   = f"models/ppo_pushball_3dof_{RUN_ID}/best_model.zip"
VECNORM_PATH = f"models/ppo_pushball_3dof_{RUN_ID}/vec_normalize.pkl"
MAX_STEPS    = 150
N_TARGET     = 20

SAVE_SUCCESS = "runs/pushball_3dof/success"
SAVE_FAIL    = "runs/pushball_3dof/fail"
...
print(f"Collecte de {N_TARGET} succès et {N_TARGET} échecs — push-ball 3-DOF\n")

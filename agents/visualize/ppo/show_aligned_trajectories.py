...
MODEL_2DOF   = MODEL_ROOT / f"ppo_reach_2dof_{run_id_2dof}" / "best_model.zip"
VECNORM_2DOF = MODEL_ROOT / f"ppo_reach_2dof_{run_id_2dof}" / "vec_normalize.pkl"
MODEL_3DOF   = MODEL_ROOT / f"ppo_reach_3dof_{run_id_3dof}" / "best_model.zip"
VECNORM_3DOF = MODEL_ROOT / f"ppo_reach_3dof_{run_id_3dof}" / "vec_normalize.pkl"

...
Collecte 20 épisodes réussis et 20 échoués — politique pushball 3-DOF transférée → env 2-DOF.
Sauvegarde dans :
...
from agents.test.transfer_pushball_3to2dof import PushBallTransfer3to2
...
print(f"Collecte de {N_TARGET} succès et {N_TARGET} échecs — transfer pushball 3→2 DOF\n")

"""
runs_pushball_3dof.py  (UNN)
Collecte N_TARGET épisodes réussis et N_TARGET échoués — politique UNN pushball 3-DOF.
Sauvegarde dans :
  runs/unn_pushball_3dof/success/ep_XXX.npz
  runs/unn_pushball_3dof/fail/ep_XXX.npz
"""
...
SAVE_SUCCESS = "runs/unn_pushball_3dof/success"
SAVE_FAIL    = "runs/unn_pushball_3dof/fail"
...
print(f"Collecte de {N_TARGET} succès et {N_TARGET} échecs — UNN push-ball 3-DOF\n")

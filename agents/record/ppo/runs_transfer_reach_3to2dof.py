...
Collecte 20 episodes reussis et 20 echoues - politique 3-DOF transferee -> env 2-DOF.
Sauvegarde dans :
...
from agents.test.ppo.transfer_reaching_3to2dof import ReachingTransfer3to2
...
MAPPER_PATH       = DATA_ROOT / "DIRECT_PPO" / "transfer_3to2_seq.pt"
...
print(f"Collecte de {N_TARGET} succes et {N_TARGET} echecs - transfer reaching 3->2 DOF\n")
